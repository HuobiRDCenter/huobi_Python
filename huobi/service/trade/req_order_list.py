...
class ReqOrderListService:
    ...
    def subscribe(self, callback, error_handler, **kwargs):
        ...
        def subscription(connection):
            connection.send(request_order_list_channel(symbol=symbol, account_id=account_id, states_str=order_states,
                                                       client_req_id=client_req_id, more_key=self.params))
