class BatchCreateOrder:
    ...
    def json_parse(json_wrapper):
        obj = BatchCreateOrder()
        obj.order_id = json_wrapper.get_int_or_default("order-id", 0)
        obj.client_order_id = json_wrapper.get_string_or_default("client-order-id", "")
        obj.err_code = json_wrapper.get_string_or_default("err-code", "")
        obj.err_msg = json_wrapper.get_string_or_default("err-msg", "")
        return obj
