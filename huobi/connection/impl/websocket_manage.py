...
class WebsocketManage:
    ...
    def close_and_wait_reconnect(self, delay_in_ms):
        print("### close_and_wait_reconnect ###")
    ...
    def close(self):
        ...
        #global_watch_dog_instance.on_connection_closed(self)
    ...
    def on_open(self, original_connection):
        ...
        #global_watch_dog_instance.on_connection_created(self)  # add to watch dog job list
