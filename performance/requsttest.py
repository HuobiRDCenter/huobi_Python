...
class RequestTest(object):
    ...
    def get_latest_candlestick(self, symbol: 'str', interval: 'CandlestickInterval', size: 'int' = 150) -> list:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_candlestick(symbol, interval, size, None, None))
    ...
    def get_candlestick(self, symbol: 'str', interval: 'CandlestickInterval', size: 'int' = 150,
        ...
        :return: The list of candlestick/kline data.
        """
        return call_sync_perforence_test(self.request_impl.get_candlestick(symbol, interval, size, start_time, end_time))
    ...
    def get_exchange_timestamp(self) -> int:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_exchange_timestamp())
    ...
    def get_price_depth(self, symbol: 'str', size: 'int' = 20) -> PriceDepth:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_price_depth(symbol, size))
    ...
    def get_last_trade(self, symbol: 'str') -> Trade:
        ...
        """
        trade_list = call_sync_perforence_test(self.request_impl.get_historical_trade(symbol, None, 1))
    ...
    def get_market_trade(self, symbol: 'str') -> list:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_market_trade(symbol))
    ...
    def get_historical_trade(self, symbol: 'str', size: 'int' = 1) -> list:
        ...
        :return: The list of trade.
        """
        return call_sync_perforence_test(self.request_impl.get_historical_trade(symbol, None, size))
    ...
    def get_24h_trade_statistics(self, symbol: 'str') -> TradeStatistics:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_24h_trade_statistics(symbol))
    ...
    def get_exchange_symbol_list(self) -> list():
        ...
        """
        symbol_list = call_sync_perforence_test(self.request_impl.get_symbols())
        return symbol_list
    ...
    def get_exchange_currencies(self) -> list():
        ...
        """
        currencies = call_sync_perforence_test(self.request_impl.get_currencies())
        return currencies
    ...
    def get_best_quote(self, symbol: 'str') -> BestQuote:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_best_quote(symbol))
    ...
    def get_withdraw_history(self, currency: 'str', from_id: 'int', size: 'int', direct=None) -> list:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_withdraw_history(currency, from_id, size, direct))
    ...
    def get_deposit_history(self, currency: 'str', from_id: 'int', size: 'int', direct=None) -> list:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_deposit_history(currency, from_id, size, direct))
    ...
    def transfer(self, symbol: 'str', from_account: 'AccountType', to_account: 'AccountType', currency: 'str',
        ...
        :return:
        """
        return call_sync_perforence_test(self.request_impl.transfer(symbol, from_account, to_account, currency, amount))
    ...
    def apply_loan(self, symbol: 'str', currency: 'str', amount: 'float') -> int:
        ...
        """
        return call_sync_perforence_test(self.request_impl.apply_loan(symbol, currency, amount))
    ...
    def repay_loan(self, load_id: 'int', amount: 'float') -> int:
        ...
        :return: The margin order id.
        """
        return call_sync_perforence_test(self.request_impl.repay_loan(load_id, amount))
    ...
    def get_loan_history(self, symbol: 'str', start_date: 'str' = None, end_date: 'str' = None,
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_loan(symbol, start_date, end_date, status, from_id, size, direction))
    ...
    def get_open_orders(self, symbol: 'str', account_type: 'AccountType', side: 'OrderSide' = None,
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_open_orders(symbol, account_type, size, side, from_id, direct))
    ...
    def cancel_open_orders(self, symbol: 'str', account_type: 'AccountType', side: 'OrderSide' = None,
        ...
        """
        return call_sync_perforence_test(self.request_impl.cancel_open_orders(symbol, account_type, side, size))
    ...
    def cancel_client_order(self, client_order_id: 'str') -> None:
        ...
        """
        return call_sync_perforence_test(self.request_impl.cancel_client_order(client_order_id))
    ...
    def get_order(self, symbol: 'str', order_id: 'int') -> Order:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_order(symbol, order_id))
    ...
    def get_order_by_client_order_id(self, client_order_id: 'str') -> Order:
        ...
        :return: The information of order.
        """
        return call_sync_perforence_test(self.request_impl.get_order_by_client_order_id(client_order_id))
    ...
    def get_match_results_by_order_id(self, order_id: 'int') -> list:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_match_results_by_order_id(order_id))
    ...
    def withdraw(self, address: 'str', amount: 'float', currency: 'str', fee: 'float' = None,
        ...
        :return: Withdraw id
        """
        return call_sync_perforence_test(self.request_impl.withdraw(address, amount, currency, fee, address_tag))
    ...
    def cancel_withdraw(self, currency: 'str', withdraw_id: 'int') -> None:
        ...
        :return: No return.
        """
        call_sync_perforence_test(self.request_impl.cancel_withdraw(currency, withdraw_id))
    ...
    def transfer_between_parent_and_sub(self, sub_uid: 'int', currency: 'str', amount: 'float',
        ...
        :return: The order id.
        """
        return call_sync_perforence_test(self.request_impl.transfer_between_parent_and_sub(sub_uid, currency, amount, transfer_type))
    ...
    def get_current_user_aggregated_balance(self):
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_current_user_aggregated_balance())
    ...
    def get_specify_account_balance(self, sub_id):
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_specify_account_balance(sub_id))
    ...
    def get_etf_swap_config(self, etf_symbol: 'str') -> EtfSwapConfig:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_etf_swap_config(etf_symbol))
    ...
    def etf_swap(self, etf_symbol: 'str', amount: 'int', swap_type: 'EtfSwapType') -> None:
        ...
        :return: No return
        """
        return call_sync_perforence_test(self.request_impl.etf_swap(etf_symbol, amount, swap_type))
    ...
    def get_etf_swap_history(self, etf_symbol: 'str', offset: 'int', size: 'int') -> list:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_etf_swap_history(etf_symbol, offset, size))
    ...
    def get_etf_candlestick(self, etf_symbol: 'str', interval: 'CandlestickInterval', size: 'int'=None) -> list:
        ...
        :return: The list of candlestick/kline data.
        """
        return call_sync_perforence_test(self.request_impl.get_etf_candlestick(etf_symbol, interval, size))
    ...
    def get_margin_balance_detail(self, symbol: 'str'=None, sub_uid:'int'=None ) -> list:
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_margin_balance_detail(symbol, sub_uid))
    ...
    def get_reference_currencies(self, currency:'str'=None, is_authorized_user:'bool' =None) ->list:
        ...
        :return: The information of trading instrument and currencies.
        """
        return call_sync_perforence_test(self.request_impl.get_reference_currencies(currency, is_authorized_user))
    ...
    def get_account_deposit_address(self, currency: 'str') ->list:
        ...
        :return:
        """
        return call_sync_perforence_test(self.request_impl.get_account_deposit_address(currency))
    ...
    def get_account_withdraw_quota(self, currency: 'str')->list:
        ...
        :return:
        """
        return call_sync_perforence_test(self.request_impl.get_account_withdraw_quota(currency))
    ...
    def get_deposit_withdraw(self, op_type:'str', currency: 'str'=None, from_id: 'int'=None, size: 'int'=None, direct:'str'=None) -> list:
        ...
        :return: The list of withdraw records.
        """
        return call_sync_perforence_test(self.request_impl.get_deposit_withdraw(op_type, currency, from_id, size, direct))
    ...
    def post_create_withdraw(self, address: 'str', amount: 'float', currency: 'str', fee: 'float',
        ...
        :return: Withdraw id
        """
        return call_sync_perforence_test(self.request_impl.post_create_withdraw(address, amount, currency, fee, chain, address_tag))
    ...
    def post_cancel_withdraw(self, withdraw_id: 'int') -> int:
        ...
        :return: No return.
        """
        return call_sync_perforence_test(self.request_impl.post_cancel_withdraw(withdraw_id))
    ...
    def post_cross_margin_transfer_in(self, currency: 'str', amount:'float') -> int:
        ...
        """
        return call_sync_perforence_test(self.request_impl.post_cross_margin_transfer_in(currency, amount))
    ...
    def post_cross_margin_transfer_out(self, currency: 'str', amount:'float') -> int:
        ...
        :return: return transfer id.
        """
        return call_sync_perforence_test(self.request_impl.post_cross_margin_transfer_out(currency, amount))
    ...
    def post_cross_margin_create_loan_orders(self, currency:'str', amount: 'float') -> int:
        ...
        """
        return call_sync_perforence_test(self.request_impl.post_cross_margin_create_loan_orders(currency, amount))
    ...
    def post_cross_margin_loan_order_repay(self, order_id:'str', amount: 'float'):
        ...
        :return: return order id.
        """
        return call_sync_perforence_test(self.request_impl.post_cross_margin_loan_order_repay(order_id, amount))
    ...
    def get_account_history(self, account_id:'int', currency:'str'=None,
        ...
        """
        return call_sync_perforence_test(self.request_impl.get_account_history(account_id, currency,
